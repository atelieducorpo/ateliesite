	...
	<div class="container">
		...
		<form method="post" action="cad2.php" id="cad">
			...
			<div class="form-group">
				...
				<input type="email" class="form-control" id="email" placeholder="Seu endereço de e-mail principal" name="email" required >
			</div>
			<div class="form-group">
				<label for="telefone">Telefones:</label>
				<input type="text" class="form-control" id="telefone" placeholder="Exmplo: (21) 98765-4321" name="telefone" required >
			</div>
			<div class="form-group">
				<label for="assunto">Assunto:</label>
				<input type="text" class="form-control" id="assunto" placeholder="Assunto do seu contato" name="assunto" required >
			</div>
			<div class="form-group">
